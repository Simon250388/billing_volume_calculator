...
interface AccountingPointMeterStateRepository extends JpaRepository<AccountingPointMeterState, Long> {
    ...
    List<AccountingPointMeterStateDTO> findAllLastActiveByKeyRoomId(@NonNull @Param("keyRoomId") long keyRoomId);
