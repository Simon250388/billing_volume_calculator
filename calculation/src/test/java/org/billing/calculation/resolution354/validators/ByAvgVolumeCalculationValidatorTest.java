...
class ByAvgVolumeCalculationValidatorTest {

  //    private final CalculationValidator validator = new ByAvgVolumeCalculationValidator();
  //    private final StabFactory stabFactory = StabFactory.builder().build();
  //
  //    @Test
  //    void
  // when_service_is_active_and_meter_state_is_active_and_there_is_meter_value_then_canCalculateVolume_return_false() {
  //        CalculationItem calculationItem =
  // CalculationItemStabFactory.getCalculationItem(stabFactory,true, MeterState.ACTIVE);
  ...
  //    @Test
  //    void
  // when_service_is_active_and_meter_state_is_active_and_there_is_no_meter_value_and_avg_volume_is_null_then_canCalculateVolume_return_true() {
  //        CalculationItem calculationItem =
  // CalculationItemStabFactory.getCalculationItem(stabFactory,true, MeterState.ACTIVE);
  //        CalculationItem spy = Mockito.spy(calculationItem);
  ...
  //    @Test
  //    void
  // when_service_is_active_and_meter_state_is_active_and_there_is_no_meter_value_and_avg_volume_is_not_null_then_canCalculateVolume_return_true() {
  //        CalculationItem calculationItem =
  // CalculationItemStabFactory.getCalculationItem(stabFactory,true, MeterState.ACTIVE);
  //        CalculationItem spy = Mockito.spy(calculationItem);
  //        Mockito.when(spy.meterValuesIsProvide()).thenReturn(false);
