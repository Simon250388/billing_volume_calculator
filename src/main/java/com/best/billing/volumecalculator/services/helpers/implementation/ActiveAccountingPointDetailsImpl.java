...
import com.best.billing.volumecalculator.models.historychange.*;
import com.best.billing.volumecalculator.repositories.historychange.*;
...
public class ActiveAccountingPointDetailsImpl implements ActiveAccountingPointDetails {
    ...
    private void doSetProviderProperty(
        ...
        currentProviders
                ...
                .forEach(value -> Optional.of(value.getServicePart())
                        .ifPresentOrElse(
